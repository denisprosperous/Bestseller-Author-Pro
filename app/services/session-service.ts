...
const getEnv = (key: string) => {
  // Safe access to environment variables in both Vite and Node.js
...
const DEV_API_KEYS = {
  ...
  google: getEnv('VITE_GOOGLE_API_KEY') || '',
  xai: getEnv('VITE_XAI_API_KEY') || '',
  deepseek: getEnv('VITE_DEEPSEEK_API_KEY') || ''
};

const USE_DEV_KEYS = getEnv('VITE_USE_DEV_API_KEYS') === 'true';
